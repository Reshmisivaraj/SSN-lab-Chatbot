...
"PG LAB-II":{components:["Desktop", "HP Laser Printer", "Raspberry Pi 4 Model B Board (4 GB RAM) with Accessories"],location:"ECE Old Block,Left Wing,First Floor"},
...
"TEXTRONIXS DESIGN AND DEVELOPMENT LAB":{components:["HP Z440 Workstation SGH816RD2B, HP V223 (2.15” FHD) LED Backlit LCD Monitor", "Multi-layer Electronics Fabrication Unit", "Special Purpose Weaving Machine", "Supply for Frame Support for Automatic Weaving Machine"], location:"ECE Annexure Block,Ground Floor"},
...
// Function to calculate a normalized similarity score between 0 and 1
...
// Find closest match with a similarity check based on Levenshtein distance
function findClosestMatch(input, options) {
    const threshold = 0.6; // Adjust threshold to be more forgiving
    let bestMatch = '';
    let bestScore = 0;
